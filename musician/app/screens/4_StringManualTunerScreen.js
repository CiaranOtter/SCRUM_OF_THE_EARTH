...
export default function _4SMTuner() {
  //   constructor() {
  //     super();
  //     this.state = {
  ...
  const tuner_type = ['4 String Tuner', '6 String Tuner', 'Chromatic Tuner'];
    ...
    <SafeAreaView style={styles.container}>
      <TouchableOpacity style={{marginTop: 80, marginLeft: 20}}>
        <SelectDropdown
          ...
          defaultButtonText={tuner_type[0]}
      ...
      <ImageBackground
        source={require('../../assets/4String.png')}
        resizeMode="contain"
